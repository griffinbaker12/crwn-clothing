import './light-dark-toggle.styles.tsx';
...
const LightDarkToggle = () => {
  ...
  window.addEventListener('click', e => {
    if (
      button.current &&
      button.current === (e.target as Element).closest('.react-toggle')
    )
  ...
  return (
    <ThemeToggleContainer
      ...
      ref={button}
    >
      <ReactToggle theme={theme} focused={focused}>
        <ReactToggleTrack>
          <ReactToggleTrackCheck>
            <img
              alt="moon"
        ...
        <ReactToggleThumb></ReactToggleThumb>
      </ReactToggle>
    </ThemeToggleContainer>
  );
};
